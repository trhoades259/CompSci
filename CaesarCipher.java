...
class CaesarCipher {
	...
	public static void main(String[] args) {
		...
		if(decrypt) for(int arrayIndex = 0; arrayIndex < charValues.length; arrayIndex++) charValues[arrayIndex]-=shift;

		else for(int arrayIndex = 0; arrayIndex < charValues.length; arrayIndex++) charValues[arrayIndex]+=shift;

		for(int arrayIndex = 0; arrayIndex < charValues.length; arrayIndex++) {

			if(charValues[arrayIndex]<0) charValues[arrayIndex]+=25;
